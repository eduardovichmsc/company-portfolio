const Hero = () => {
	return (
		<div className="container m-auto hero flex-col justify-center items-center">
			<p className="w-fit m-auto font-bold text-orange-500 tracking-tight border-orange-500 border-2 border-opacity-50 px-3 py-1 my-4 rounded-full flex gap-2">
			...
			<p className="text-lg font-medium tracking-tight max-w-[50%] mx-auto my-6 text-center leading-relaxed text-neutral-500">
