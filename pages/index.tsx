	...
	return (
		<main className={`min-h-screen ${poppins.className}`}>
			...
			<div className="bg-white w-full">
				<div className="container mx-auto py-[3vw]">
					<p className="text-5xl font-bold tracking-tight text-center">
						Our Collaborative Approach
					</p>
					<p className="text-center font-medium text-neutral-600 mt-4">
			...
			<div className="flex flex-col gap-32 pt-36 pb-16">
				<div className="container m-auto w-full flex">
					...
					<div className="size-1/2 ml-40 py-16 flex flex-col gap-2">
						<p className="text-5xl font-semibold leading-tight tracking-tighter">
						...
						<div className="flex flex-col gap-4 mt-6">
							...
							<p className="font-medium text-xl text-neutral-500 tracking-tighter w-[80%]">
						...
						<div className="flex flex-col gap-4 mt-6">
							...
							<p className="font-medium text-xl text-neutral-500 tracking-tighter w-[85%]">
				...
				<div className="container m-auto flex justify-between">
					<div className="size-[45%] flex flex-col gap-4">
						...
						<p className="font-medium text-xl text-neutral-500 tracking-tighter ">
						...
						<div className="flex mt-6 gap-20">
							<div className="flex flex-col">
								<p className="text-6xl text-orange-600 font-medium tracking-tighter ">
									205M+
								</p>
								<p className="text-xl font-medium mt-4 tracking-tight leading-3">
